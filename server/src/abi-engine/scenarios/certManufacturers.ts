...
export const CERT_MANUFACTURERS: CertManufacturer[] = [
  ...
  { mid: 'CHZURPAS135ZUR', name: 'ZURICH PASTA AG', street: '135 BAHNHOFSTRASSE', city: 'ZURICH', countryCode: 'CH' },
  { mid: 'FRPARMUS791PAR', name: 'PARIS MUSHROOMS', street: '791 RUE DE SEINE', city: 'PARIS', countryCode: 'FR' },
  { mid: 'ITMILTOM468MIL', name: 'MILANO TOMATO SRL', street: '468 VIA ROMA', city: 'MILANO', countryCode: 'IT' },
  { mid: 'CLSCLPUL802SCL', name: 'S.C.L. PULP SA', street: '802 CAMINO FORESTAL', city: 'SCL', countryCode: 'CL' },
  { mid: 'KRSELSTE579SEL', name: 'S.E.L. STEEL', street: '579 GANGNAM-DAERO', city: 'SEL', countryCode: 'KR' },
  ...
  { mid: 'KRSELWIG217SEL', name: 'S.E.L. WIGS', street: '217 JONGNO', city: 'SEL', countryCode: 'KR' },
  { mid: 'ESMADALU365MAD', name: 'MADRID ALUMINIO SA', street: '365 GRAN VIA', city: 'MADRID', countryCode: 'ES' },
  { mid: 'VCKINMEA754KIN', name: 'KINGSTOWN MEATS', street: '754 BAY ST', city: 'KINGSTOWN', countryCode: 'VC' },
  { mid: 'ITMILFER426MIL', name: 'MILANO FERTILIZZANTI', street: '426 CORSO BUENOS AIRES', city: 'MILANO', countryCode: 'IT' },
  { mid: 'TWTPEFER538TPE', name: 'T.P.E. FERTILIZERS', street: '538 ZHONGSHAN RD', city: 'TPE', countryCode: 'TW' },
  { mid: 'KRSELFER649SEL', name: 'S.E.L. FERTILIZER', street: '649 MAPO-DAERO', city: 'SEL', countryCode: 'KR' },
  { mid: 'GLGOHWAT219GOH', name: 'G.O.H. WATCH REPAIR', street: '219 IMANEQ', city: 'GOH', countryCode: 'GL' },
  { mid: 'JPMATELE288OSA', name: 'MATSUSHITA ELECTRIC', street: '288 KADOMA', city: 'OSAKA', countryCode: 'JP' },
  { mid: 'ZAJNBLEA318JNB', name: 'J.N.B. LEATHER', street: '318 COMMISSIONER ST', city: 'JNB', countryCode: 'ZA' },
  { mid: 'KRSELWOO471SEL', name: 'S.E.L. WOOD PRODUCTS', street: '471 TEHERAN-RO', city: 'SEL', countryCode: 'KR' },
  { mid: 'HTPAPTEX593PAP', name: 'P.A.P. TEXTILES', street: '593 RUE PAVEE', city: 'PAP', countryCode: 'HT' },
  { mid: 'JPTYOAUT137TYO', name: 'T.Y.O. AUTOS', street: '137 SHIBAURA', city: 'TYO', countryCode: 'JP' },
  ...
  { mid: 'HKHKGRAD529HKG', name: 'H.K.G. RADIO', street: '529 DES VOEUX RD', city: 'HKG', countryCode: 'HK' },
  { mid: 'KRSELALU906SEL', name: 'S.E.L. ALUMINUM', street: '906 OLYMPIC-RO', city: 'SEL', countryCode: 'KR' },
  { mid: 'TWNICSAN435TAI', name: 'NICSAN', street: '435 INDUSTRIAL RD', city: 'TAICHUNG', countryCode: 'TW' },
];
