...
export const MPF_EXEMPT_SPI = new Set([
  ...
  'W',
  // NOT 'D': AGOA does NOT exempt MPF — live F633 FORMAL MPF REQUIRED -
  // ARTICLE NOT EXEMPT, scenario 051, 9/8. The unilateral-programs
  // analogy (Y/W) does not extend to it.
]);
